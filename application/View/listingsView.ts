...
function listings(personalInfoAssociatArray,sessionStatus){
  ...
  //Embedding personal information 
    const content =  
      `<h1>Posts</h1>
      <p>${(sessionStatus==null)?'<a href="/login">Login</a> to Create a Post!':'Welcome '+sessionStatus.userName+', You may <a href="/create">Create a Post</a> or <a href="/logout">Logout</a>!<br><p><a href="/manager">Manager Page</p>'}</p>

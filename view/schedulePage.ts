const showSchedule = ({response},{response:any}) =>{
    response.body=`
    <!DOCTYPE html>
    <html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/Event-Schedule.css">
    ...
    <div class="event-schedule-area-two bg-color pad100">
        ...
        <script id="bs-live-reload" data-sseport="58255" data-lastchange="1666937525920" src="/js/livereload.js"></script>
    </body>
